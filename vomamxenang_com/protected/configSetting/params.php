<?php
            ...
            //
	define('ADMIN_ADDRESS', '27/21 Bùi Tư Toàn, F.An Lạc, Q.Bình Tân');
//
	define('ADMIN_EMAIL', 'gangtergilla4@gmail.com');
//
	define('APPROVED', 1);
	define('HOTLINE', '0913.600.210 - Thanh hoặc 012.79.59.39.79 - Tú');
//
	define('BO_PAGE_SIZE', 10);
//
	define('BO_SUPER_ADMIN_THEME', 'SuperAdmin');
//
	define('BO_THEME', 'Backend');
//
	define('Cache_Time', 600);
//
	define('commentCount', 10);
//
	define('DB_HOST' , '192.3.171.132');
//
	define('DB_NAME' , 'zadmin_vomamxenang');
//
	define('DB_PORT' , 3306);
//
	define('DB_PSWD' , 'a4e7abaju');
//
	define('DB_USER' , 'thietkeweb3in1');
//
...
//
	define('SMTP_USERNAME', 'gangtergilla4@gmail.com');
//
	define('tagCloudCount ', 10);
//
